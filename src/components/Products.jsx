    ...
    <>
      <main className="p-[10px] pl-[10px] md:pl-[17rem] w-full">
        ...
        <div className="flex-1 md:p-6 ">
          ...
          <p className="text-sm text-gray-600 mb-6">Manage all products on your website.</p>
          <div className="p-4 sm:p-8 bg-gray-50 min-h-screen">
            <div
              className={`overflow-x-auto rounded-lg ${fetchingProducts ? 'p-10 shadow-none' : `${products && products?.length > 0 && 'shadow-lg'}`}`}
            >
              {fetchingProducts ? (
                ...
                <table className="min-w-full bg-white border border-gray-200">
                  <thead className="bg-blue-100 text-gray-700">
                    <tr>
                      ...
                      <th className="px-3 py-4 text-left">Ratings</th>
                          ...
                          <td className="px-4 py-3 flex gap-2">
                            ...
                            >
                              {selectedProduct?.id === product.id && loading ? (
                                <>
                                  <LoaderCircle className="w-6 h-6 animate-spin" /> Deleteing...
                                </>
                              ) : (
                                'Delete'
                              )}
